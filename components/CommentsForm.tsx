        ...
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div>
                    ...
                    <label className="text-gray-500 cursor-pointer" htmlFor="storeData"> Salvar dados para um próximo comentário.</label>
                </div>
            </div>
            {error && <p className="text-xs text-red-500">Preencher todos os campos 😁</p>}
            <div className="mt-8">
                <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-blue-900 inline-block bg-blue-700 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Comentário</button>
                {showSuccessMessage && <span className="text-xl float-right font-semibold mt-3 text-green-500">Comentário enviado para review 😎</span>}
            </div>
        </div>
    );
};
